...
function ManageSpots () {
        ...
        return (
            // <Link id={`spot${id}`} to={`/spots/${id}`}>
                <div className='spots-square' id={id}>
                    ...
                    <div>
                        <button className='manage-spots-update' onClick={() => {
                            history.push(`/spots/${id}/edit`)
                        }}>Update</button>
                        <button className='manage-spots-update'><OpenModalButton textColor='white' buttonText='Delete' modalComponent={<DeleteSpotModal spotId={id} />} /></button>
    ...
    return (
        <div className='manage-spots-container'>
            ...
            <div className='manage-spot-tile-box'>
                {loadEachSpotTile}
            </div>
