  ...
  if (!Reviews.length) {
    ...
    reviewInfo = (
      <p>
        ...
        {formatRating(avgStarRating)} · {numReviews} {reviewInnerText}
      </p>
    );
  }
  ...
  return (
    <div className="spot-details-box">
      ...
      <p className="spot-details-location">
        {capitalizeWords(city)}, {capitalizeWords(state)},{" "}
      ...
      <div className="reviews-header">
        <div className="review-info">{reviewInfo}</div>
        <div
          className={
            !currentOwner && loggedIn && canPost ? "visible" : "hidden"
          }
        >
        ...
        {!Reviews.length && (
          <p className={!currentOwner && loggedIn ? "visible" : "hidden"}>
